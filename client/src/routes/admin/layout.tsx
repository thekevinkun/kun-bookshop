...
export default function AdminLayout() {
  ...
  return (
    // Full-screen layout — dark background, flex row so sidebar and content sit side by side
    <div className="min-h-screen bg-[#0F172A] flex">
      ...
      <aside
        className={`
          fixed top-0 left-0 h-full w-64 bg-[#1E293B] border-r border-slate-700/50
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="lg:hidden flex items-center gap-3 px-4 py-4 border-b border-slate-700/50 bg-[#1E293B]">
          <button
